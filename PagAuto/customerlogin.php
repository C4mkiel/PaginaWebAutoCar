...
?>
    ...
    <head>
        <title> Cliente login | AutoCarWin </title>
    </head>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        ...
        <div class="container">
            <div class="jumbotron">
            <h1 class="text-center">AutoCarWin  </span>
                </h1>
                <br>
                <p class="text-center">Porfavor ingrese para continuar.</p>
            </div>
        </div>
                        ...
                        <form action="" method="POST">
                            <div class="row">
                                <div class="form-group col-xs-12">
                                    <label for="customer_username"><span class="text-danger" style="margin-right: 5px;">*</span> Nombre usuario: </label>
                                    <div class="input-group">
                                        <input class="form-control" id="customer_username" type="text" name="customer_username" placeholder="Ususario" required="" autofocus="">
